...
namespace QuanLyThuVien.Data
{
    ...
    {
        public static ThongKeTongHop LayTongHop(DateTime tuNgay, DateTime denNgay)
        {
        ...
        public static DataTable LayChiTietPhat(DateTime tuNgay, DateTime denNgay)
        {
            return Db.Query(@"
                SELECT pp.MaPhieuPhat, pp.NgayPhat, pm.MaDocGia, ct.MaDauSach, s.TenSach, pp.LyDo, pp.PhiPhat, pp.MaNhanVien
                FROM PhieuPhat pp
