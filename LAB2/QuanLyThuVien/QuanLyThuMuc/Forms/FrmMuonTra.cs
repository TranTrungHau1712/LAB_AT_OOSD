...
namespace QuanLyThuVien
{
    public partial class FrmMuonTra : Form
    {
        ...
        {
            DataTable readers = DocGiaService.LayDanhSach();
            readers.Columns.Add("HoTen", typeof(string), "Ho + ' ' + Ten");
            ...
            DataTable staff = DanhMucService.LayDanhSachNhanVien();
        ...
        {
            get { return cboDocGia.SelectedValue == null ? "" : cboDocGia.SelectedValue.ToString(); }
        }

        private string MaDocGiaTra
        {
            get { return cboDocGiaTra.SelectedValue == null ? "" : cboDocGiaTra.SelectedValue.ToString(); }
        }

        private string MaNhanVienMuon
        {
            get { return cboNhanVienMuon.SelectedValue == null ? "" : cboNhanVienMuon.SelectedValue.ToString(); }
        }

        private string MaNhanVienTra
        {
            get { return cboNhanVienTra.SelectedValue == null ? "" : cboNhanVienTra.SelectedValue.ToString(); }
        }
        ...
        {
            KetQuaXuLy kq = MuonTraService.KiemTraDieuKienMuon(MaDocGiaMuon, Math.Max(1, selectedBooks.Rows.Count));
        ...
        private void btnLapPhieu_Click(object sender, EventArgs e)
        {
            ...
            KetQuaXuLy kq = MuonTraService.LapPhieuMuon(MaDocGiaMuon, MaNhanVienMuon, ds, dtNgayMuon.Value, dtHenTra.Value);
        ...
        private void TaiSachDangMuon()
        {
            ...
            dgvDangMuon.DataSource = MuonTraService.LaySachDangMuon(MaDocGiaTra);
        ...
        private void btnTraSach_Click(object sender, EventArgs e)
        {
            ...
            KetQuaXuLy kq = MuonTraService.TraSach(maCT, MaNhanVienTra, dtNgayTra.Value,
